              ...
              <div class="flex items-center ">
                ...
                <div v-else class="xl:p-2  ">
                  ...
                  <div v-if="typePay === 'card'" class="">
                    ...
                    <div class=" xlchikito:h-[20rem] NestHubMax:h-auto  lg:h-[17rem]  h-[20rem] overflow-y-auto">
                      <div class="text-center flex flex-col">
                        <label for="" class="block text-transparent bg-clip-text bg-gradient-to-r
                      from-[#A6CBFF]
                      to-[#C8DEFF] text-base font-medium mb-2">Método seleccionado</label>
                        <img src="/Metodos/tarjeta.svg" alt="" class="h-[5rem]">
                        <label for="" class="block text-transparent bg-clip-text bg-gradient-to-r
                      from-[#A6CBFF]
                      to-[#C8DEFF] text-base font-medium mb-2">Tarjeta</label>
                      </div>
                      <div class="lg:flex  sm:p-2">
