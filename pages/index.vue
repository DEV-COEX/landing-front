<template>
  <div class="grid w-full h-screen">
    ...
    <div
      class=" z-0 flex bg-gradient-to-r from-[#321586] via-[#4736df] to-[#2E1477] background-animate  h-screen w-full justify-center items-end"
      style="position:absolute;">
      <button class="circulo" @click="metodoCambio"></button>
    </div>
  </div>
</template>
